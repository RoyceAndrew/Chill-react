    ...
    return (
        <section id="hero">
            ...
            id="hero-video"
                ...
                alt="hero-img"
            />
            <div className="relative z-30 flex flex-col gap-1 justify-end pt-[350px] pb-[40px] md:gap-5 md:pb-[50px] px-5 h-[600px] mt-[-599px] bg-home-gradient">
                <h1 className="text-[40px]">Suzume</h1>
                <p
                    id="desc"
                    className="md:w-[50%]  text-[16px]"
                >
