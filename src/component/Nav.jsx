...
export const Nav = () => {
    ...
    <Link className="transition-all flex items-center lg:ml-10  ease-out hover:scale-110" to="/"><img className="h-[18px]  lg:h-[24px]" src='./picture/Vector.png' alt='chill-logo'/><p className="font-normal hidden lg:block londrina text-[32px]">CHILL</p> </Link>
