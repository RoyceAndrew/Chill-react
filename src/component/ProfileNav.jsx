...
export const ProfileNav = (props) => {
    ...
    return <div className={`md:mr-14 mr-1 ${visible ? "flex flex-col justify-center md:items-center items-end" : "none"}` } onClick={handleClick}><button className="flex gap-2 items-center cursor-pointer"><img className="h-[30px] w-[30px] object-cover rounded-3xl" id="profile-pct" src="./picture/profilepct.jpg" alt="profile-pct"/><i class="bi bi-chevron-down"></i></button>
    <div className={`fixed gap-2 top-16 bg-home-color flex flex-col w-[150px] p-[10px] rounded-md ${visible ? "visible" : "collapse"}`}>
