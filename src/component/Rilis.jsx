...
export const Rilis = () => {
    ...
    return <section className="p-[20px] mb-10 flex items-start overflow-hidden xl:items-center  justify-center bg-home-color flex-col w-full" id="series">
    <div>
        <h2 className="xl:text-[30px] text-[20px]">Rilis Baru</h2>
