...
export const ImgList = (props) => {
    ...
    <div onMouseOver={() => setDetail(true)} onMouseOut={() => setDetail(false)} className={`${detail ? "block" : "hidden collapse"}  absolute top-[-20px] ${props.horiz ? "left-[-20px]" : "left-[-110px]" }   h-[254px] w-[408px] z-30`}>
