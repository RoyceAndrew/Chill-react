...
export const ImgList = (props) => {
    ...
    <div onMouseOver={() => setDetail(true)} onMouseOut={() => setDetail(false)} className={`${allow && detail ? "block" : "hidden collapse"}  absolute top-[-20px] ${props.horiz ? "top-[-60px] left-[-20px]" : "left-[-110px]" }   h-[254px] w-[408px] z-30`}>
        <img className={`h-full w-full rounded-tl-lg rounded-tr-lg  object-fill object-top`} src={props.imghoriz}/><div className="bg-[rgb(40,40,40)] rounded-br-lg rounded-bl-lg p-5">
